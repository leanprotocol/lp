  ...
  async function handlePay() {
    ...
    try {
      ...
      const razorpay = new (window as any).Razorpay({
        ...
        name: "Lean Protocol â€” GLP-1 Doctor Consultation", description: "1:1 GLP-1 Doctor Consultation · â‚¹49",
      ...
      <div className="modal-box">
        ...
        {!success ? (
          <>
            ...
            <p style={{ fontSize: "11px", color: "var(--sage)", textAlign: "center", marginTop: "10px" }}>ðŸ”’ 256-bit secure · UPI / Cards / Netbanking</p>
          </>
        ) : (
  ...
  return (
    <>
      ...
      <div className="sticky-cta">
        <div className="txt">Very limited slots today<b>GLP-1 Consultation · â‚¹49</b></div>
