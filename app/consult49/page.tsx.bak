...
const DOCTORS = [
  { initials: "NJ", name: "Dr. Nishant Jain", role: "MD, DM Â· Endocrinologist", hosp: "Kailash Deepak Hospital", img: "https://www.leanprotocol.in/lp-assets/experts/nishant.jpeg" },
  { initials: "AK", name: "Dr. Akhil Konduru", role: "MD Â· Internal Medicine", hosp: "Medanta (former)", img: "https://www.leanprotocol.in/lp-assets/experts/akhil.jpeg" },
  { initials: "SG", name: "Dr. Siddharth Garg", role: "MD Â· Internal Medicine", hosp: "Yashoda Hospital", img: "https://www.leanprotocol.in/lp-assets/experts/siddharth.jpeg" },
];
...
const TESTIMONIALS = [
  { initial: "P", name: "Pratima", age: "37 yrs", quote: "I finally found a program that understood my body.", result: "âˆ’7 kg", when: "in 2.5 months", type: "image" as const, src: "/before-after/Pratima, 37 Lost 7Kgs in 2.5 months.jpeg" },
  { initial: "M", name: "Manav", age: "24 yrs", quote: "The food noise went quiet. My doctor adjusted my plan every week.", result: "âˆ’20 kg", when: "in 5 months", type: "video" as const, src: "/before-after/manav.mp4" },
  ...
  { initial: "A", name: "Ayushi", age: "22 yrs", quote: "First plan with actual science behind it. The check-ins kept me going.", result: "âˆ’15 kg", when: "in 6 months", type: "video" as const, src: "/before-after/ayushi.mp4" },
  { initial: "A", name: "Ananya", age: "20 yrs", quote: "The at-home blood test found what years of dieting missed.", result: "âˆ’14 kg", when: "in 7 months", type: "video" as const, src: "/before-after/ananya.mp4" },
  ...
  { initial: "R", name: "Roshni", age: "23 yrs", quote: "Doctor-led made all the difference.", result: "âˆ’15 kg", when: "in 6 months", type: "video" as const, src: "/before-after/roshni.mp4" },
  { initial: "R", name: "Rohit", age: "39 yrs", quote: "Labs, doctor, dietitian, delivery â€” everything in one place.", result: "âˆ’9.1 kg", when: "in 15 weeks", type: "image" as const, src: "/before-after/Rohit, 39 Lost 9.1 kg in 15 weeks.png" },
  { initial: "A", name: "Atreyee", age: "28 yrs", quote: "The constant motivation made all the difference.", result: "âˆ’6 kg", when: "in 1 month", type: "video" as const, src: "/before-after/atreyee.mp4" },
];
...
/* â”€â”€â”€ Doctor Carousel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  return (
    <>
      <div className="doc-carousel">
        ...
        <button className="dc-arrow prev" onClick={() => go(active - 1)} aria-label="Previous">â€¹</button>
        <button className="dc-arrow next" onClick={() => go(active + 1)} aria-label="Next">â€º</button>
      </div>
...
/* â”€â”€â”€ BMI Calculator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        ...
        <div className="bmi-card">
          <div className="bmi-top">
            <div>
              ...
              <button className="btn btn-primary" style={{ width: "100%", fontSize: "17px" }} onClick={handleCheck}>Check my eligibility <span className="arrow">â€º</span></button>
            </div>
          ...
          {showResult && (
            <div className="bmi-result show">
              <div className={`elig ${eligible ? "yes" : "no"}`}>{eligible ? "ðŸŽ‰ You are eligible for the GLP-1 / Mounjaro plan" : "ðŸ˜” Based on your BMI, you are not eligible yet"}</div>
              {eligible && (<div className="glp-box show"><h4>You&apos;re eligible for the GLP-1 / Mounjaro plan ðŸŽ¯</h4><p>A doctor-supervised path shown to deliver up to ~22% body-weight loss. Your â‚¹49 consultation is the first step.</p></div>)}
              ...
              {!submitted ? (
                <div className="lead-mini">
                  ...
                  <div className="sub">Enter your details â€” our team shares your report &amp; books your â‚¹49 consultation.</div>
                  <form onSubmit={handleBMILead} noValidate>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ width: "100%", opacity: bmiFormValid ? 1 : 0.5, cursor: bmiFormValid ? "pointer" : "not-allowed" }} disabled={!bmiFormValid}>Get my report &amp; book â‚¹49 consult <span className="arrow">â€º</span></button>
                  </form>
                </div>
              ) : (
                <div className="lead-mini"><div className="lead-done show"><div className="check-ic">âœ“</div><h4>You&apos;re all set!</h4><p style={{ color: "var(--sage)", fontSize: "14px", margin: "6px 0 14px" }}>Continue to confirm your â‚¹49 consultation.</p><button className="btn btn-primary zoom" style={{ width: "100%" }} onClick={() => onOpenModal(formName, formPhone, bmi.toFixed(1))}>Continue to â‚¹49 checkout â†’</button></div></div>
              )}
            </div>
          )}
        </div>
...
/* â”€â”€â”€ Scroll reveal + Confetti â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€â”€ Joiner Toast â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
const JOINER_ACTIONS = ["booked a â‚¹49 consultation", "joined the program", "checked their BMI eligibility", "requested a callback"];
...
/* â”€â”€â”€ Roll-up stats counter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function RollupStats() {
  const [vals, setVals] = useState([0, 0, 0, 0]);
  const targets = [17, 10000, 4.8, 99];
  const suffixes = [" kg", "+", "â˜…", "+"];
  const labels = ["avg fat loss Â· 6 months*", "transformations", "rated by members", "countries approved"];
...
/* â”€â”€â”€ Checkout Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function CheckoutModal({ onClose, prefillName = "", prefillPhone = "", prefillBmi = "" }: {
  ...
  async function handlePay() {
    ...
    try {
      // Fire-and-forget lead capture â€” so even if payment is abandoned, lead is in CRM
      ...
      const razorpay = new (window as any).Razorpay({
        ...
        name: "Lean Protocol â€” GLP-1 Doctor Consultation", description: "1:1 GLP-1 Doctor Consultation Â· â‚¹49",
        ...
        {!success ? (
          <>
            <div className="modal-head">
              ...
              <div className="modal-price">â‚¹49 <span style={{ textDecoration: "line-through", color: "#9ca3af" }}>â‚¹1,500</span></div>
            </div>
            ...
            <ul className="modal-incl">
              <li><b>âœ“</b> Live 1:1 video call with a GLP-1 expert</li>
              <li><b>âœ“</b> Personalised fat-loss plan</li>
              <li><b>âœ“</b> Root cause analysis</li>
              <li><b>âœ“</b> Prescription right at your inbox</li>
            </ul>
            ...
            <button className="btn btn-primary" style={{ width: "100%", marginTop: "12px", fontSize: "17px", opacity: (paying || !formValid) ? 0.5 : 1, cursor: (paying || !formValid) ? "not-allowed" : "pointer" }} onClick={handlePay} disabled={paying || !formValid}>
              {paying ? "Processingâ€¦" : "Pay â‚¹49 & Book"}
            </button>
            <p style={{ fontSize: "11px", color: "var(--sage)", textAlign: "center", marginTop: "10px" }}>ðŸ”’ 256-bit secure Â· UPI / Cards / Netbanking</p>
          </>
        ) : (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            <div className="c-success-ic">âœ“</div>
            ...
            <a href="https://wa.link/3s1upf" className="btn btn-wa" style={{ width: "100%" }}>ðŸ’¬ Message us on WhatsApp</a>
          </div>
        )}
      </div>
    </div>
...
/* â”€â”€â”€ 10-minute offer timer (persists across refresh) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ...
    <div style={{ width: "100%", boxSizing: "border-box", maxWidth: "520px", margin: "16px auto 0" }}>
      <div style={{
        ...
        <div style={{ fontSize: "12.5px", fontWeight: 800, letterSpacing: ".05em", textTransform: "uppercase", color: "#fff" }}>
          â° Hurry! This â‚¹49 offer ends soon ðŸ”¥
        </div>
        ...
        <div style={{ fontSize: "11.5px", color: "#FCE4E1", fontWeight: 600 }}>
          {over ? "ðŸ˜” Slot released â€” book now to check availability" : "âš¡ Your slot is reserved â€” don't lose it!"}
        </div>
      </div>
    </div>
  );
...
function Consult49Content() {
  ...
  return (
    <>
      <div className="urgency-bar">ðŸ”’ GLP-1 Doctor Consultation â€” Now at Just â‚¹49 (Was â‚¹1,500)</div>
      ...
      <section className="docs-first" style={{ background: "linear-gradient(180deg, #EAF3EE 0%, #F4F9F6 45%, #FFFFFF 100%)" }}>
        <div className="wrap">
          <div className="sec-head" style={{ marginBottom: "22px" }}><div className="divider"></div><h2>Talk to real GLP-1 doctors before you spend â‚¹15,000 on medication</h2><p>Live 1:1 video consult with certified endocrinologists &amp; internal medicine doctors for just â‚¹49.</p></div>
          <style>{`
          ...
          <div className="doc-row">
            {[
              { img: "/consult49/doctor-1.png", name: "Dr. Nishant Jain", role: "MD, DM Â· Endocrinologist", hospital: "Kailash Hospital" },
              { img: "/consult49/doctor-2.png", name: "Dr. Akhil Konduru", role: "MD Â· Internal Medicine", hospital: "Yashoda Hospital" },
              { img: "/consult49/doctor-3.png", name: "Dr. Siddharth Garg", role: "MD Â· Internal Medicine", hospital: "Former Medanta, Gurgaon" },
            ].map((d, i) => (
        ...
        <div className="wrap hero-center">
          ...
          <div className="offer-card">
            ...
            <div className="price-row">
              ...
              <span className="price-big">â‚¹49</span>
              <span className="price-was">â‚¹1,500</span>
              <span className="price-save">97% OFF</span>
            </div>
            <ul>
              <li><b>âœ“</b> Live 1:1 Video Call</li>
              <li><b>âœ“</b> Personalized Fat Loss Plan</li>
              <li><b>âœ“</b> Root Cause Analysis</li>
              <li><b>âœ“</b> Prescription right at your inbox</li>
            </ul>
            <div className="tagline">ONE SMALL STEP. TO A LEANER YOU.</div>
            <button className="btn btn-primary" onClick={() => openModal()}>Book Now at Just <span className="pill49">â‚¹49</span></button>
          </div>
          <CountdownTimer minutes={10} />
        </div>
      </section>

      {/* Stats â€” roll-up counter */}
      <RollupStats />

      {/* Testimonials â€” real media */}
      <section>
        <div className="wrap">
      ...
      <section className="alt" id="roadmap">
        <div className="wrap">
          ...
          <div className="rmap reveal">
            {[
              { eyebrow: "2 MINUTES", h: "Book your â‚¹49 consultation", p: "Reserve your â‚¹49 slot in under a minute â€” no clinic queues, no waiting rooms." },
      ...
      {/* Google Reviews â€” real screenshots */}
      <section id="reviews" className="alt">
        <div className="wrap">
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", marginBottom: "30px", flexWrap: "wrap" }}>
            ...
            <div style={{ fontFamily: "var(--display)", fontSize: "38px", color: "var(--green)", lineHeight: 1 }}>4.8 <span style={{ color: "#FBBC05", fontSize: "22px" }}>â˜…â˜…â˜…â˜…â˜…</span></div>
          </div>
      ...
      <section className="press reveal">
        <div className="wrap">
          <div className="label">Lean Protocol â€” Featured across India&apos;s leading publications</div>
      ...
      <section id="faq" className="alt">
        <div className="wrap">
          ...
          <div className="faq-list reveal">
            {[
              { q: "Who is eligible for the weight-loss program?", a: "Generally a BMI of 30 or above qualifies â€” or 27+ with a weight-related condition like PCOS, thyroid, hypertension or diabetes. Final eligibility is always decided by your doctor during the consultation." },
              ...
              { q: "Are medicines included in the â‚¹49?", a: "No â€” â‚¹49 covers the consultation and root cause analysis only. If the doctor recommends medicines or tests, you'll see transparent pricing and can decide before anything is dispensed." },
        ...
        <div className="wrap">
          <div className="final-inner">
            <div className="final-text">
              ...
              <button className="btn btn-primary zoom" style={{ fontSize: "18px", padding: "17px 40px", marginTop: "8px" }} onClick={() => openModal()}>Book Now <span className="pill49">â‚¹49</span></button>
        ...
        <div className="wrap">
          <div className="foot-grid">
            <div style={{ maxWidth: "300px" }}>
              <div className="logo" style={{ marginBottom: "14px" }}><div className="mark">LP</div><div className="name">LEAN <b>PROTOCOL</b><span>DOCTOR-LED Â· SCIENCE-BACKED</span></div></div>
              <p style={{ fontSize: "13px", color: "var(--sage)" }}>Doctor-led, science-backed weight care â€” consultations, prescriptions, and support.</p>
            </div>
