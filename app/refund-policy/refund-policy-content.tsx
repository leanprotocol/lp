          ...
          <div className="p-4 md:p-12 space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-1 mb-4 text-[#57534E] pl-2 list-decimal">
                <li className="ml-3">You are a <b>new Lean Protocol customer</b> enrolling for the first time.</li>
                <li className="ml-3">Your <b>starting BMI is 30 or higher</b>, as assessed during onboarding and confirmed by a Lean Protocol doctor.</li>
                <li className="ml-3">You are enrolled in a <b>doctor-approved GLP-1 based therapy program</b> with Lean Protocol.</li>
              </ul>
            </section>
            <section>
              ...
              <div className="space-y-5">
                <section>
                  ...
                  <p className="text-[#57534E]">Your body weight must be recorded using the Lean Protocol smart scale in <b>at least 70% of the weeks</b> during your program. (Eg around 9 of 12 weeks)<br />The final weight must be recorded <b>within 15 days</b> of the completion of the 6-month results window.</p>
                </section>
                <section>
                ...
                <section>
                  ...
                  <p className="text-[#57534E]">Doctor consultations must be attended <b>at least once per month</b> throughout the program duration.<br />Nutritionist consultations must be attended <b>at least twice per month</b> throughout the program duration.</p>
                </section>
                <section>
            ...
            <section>
              ...
              <ul className="space-y-1 mb-4 text-[#57534E] pl-2 list-disc">
                <li className="ml-3">Your <b>starting weight</b> is the first valid smart-scale reading recorded during onboarding.</li>
                <li className="ml-3">Your <b>final weight</b> is the last valid smart-scale reading recorded within the allowed completion window.</li>
                <li className="ml-3">Percentage weight loss is calculated using these two measurements only.</li>
                <li className="ml-3">Manual, altered, or manipulated data may invalidate eligibility.</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif text-2xl text-[#1F302B] mb-4">Refund Eligibility and Calculation</h2>
              <p className="text-[#57534E] mb-4">If you meet <b>all eligibility and adherence criteria</b> and do not achieve at least <b>10% weight loss by the end of 6 months</b>, your case will be reviewed for a refund. Approved refunds may be approved, considering:</p>
              <ul className="space-y-1 mb-4 text-[#57534E] pl-2 list-disc">
              ...
              <p className="text-[#57534E] mt-4 text-sm italic">The final refund amount may be <b>full if the person showed attendance and adherence as per the T&C</b>.</p>
            </section>
            <section>
            ...
            <section>
              ...
              <ul className="space-y-1 text-[#57534E] text-sm">
                <li className="flex gap-2 items-center"><span className="text-red-300 font-bold text-xs">X</span> You cancel the program early for non-medical reasons.</li>
                <li className="flex gap-2 items-center"><span className="text-red-300 font-bold text-xs">X</span> You fail to meet the adherence requirements outlined above.</li>
                <li className="flex gap-2 items-center"><span className="text-red-300 font-bold text-xs">X</span> You provide incomplete, inaccurate, or misleading medical info.</li>
                <li className="flex gap-2 items-center"><span className="text-red-300 font-bold text-xs">X</span> There is evidence of unsafe behavior, misuse, or non-compliance.</li>
                <li className="flex gap-2 items-center"><span className="text-red-300 font-bold text-xs">X</span> There is suspected fraud, data manipulation, or abuse of the program.</li>
              </ul>
            </section>
            <section>
            ...
            <section>
              <h2 className="font-serif text-2xl text-[#1F302B] mb-4">Final Authority and Policy Updates</h2>
              <p className="text-[#57534E] leading-relaxed mb-4">All refund decisions under this policy are made by Lean Protocol and are final, subject to applicable law.</p>
              <p className="text-[#57534E] leading-relaxed">Lean Protocol reserves the right to update or modify this policy. The version applicable to you will generally be the one in effect at the time of purchase unless a change is required by law.</p>
            </section>
          </div>
        </div>
      </div>
