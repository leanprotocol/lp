            ...
            <ul className="space-y-4">
              ...
              <li className="pt-2">
                <a
                  ...
                  className="inline-flex items-center justify-center border border-accent2/40 hover:border-accent2 text-accent2/80 hover:text-white text-sm font-medium rounded-full px-5 py-2 transition-colors duration-200"
                >
                  Contact us
                </a>
              </li>
