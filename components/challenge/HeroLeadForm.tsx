...
export function HeroLeadForm() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.consent) {
      next.consent = "Please accept the privacy policy to continue";
    }
  ...
  return (
    <div className="form-card" id="formCard">
      <span className="tag">⚡ ₹449 consultation — Limited Seats</span>
      <h3>Join the 30 Days Hard Challenge</h3>
      <div className="fsub">Book your ₹449 doctor consultation — our team calls you back within 24 hours.</div>
      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} noValidate>
          ...
          {errors.consent && <div className="msg" style={{ display: "block", marginTop: "-8px", marginBottom: "10px" }}>{errors.consent}</div>}
