...
export function TransformationSlider() {
  ...
  useEffect(() => {
    if (day >= 30 && !firedRef.current) {
      firedRef.current = true;
      (window as any).lpConfetti?.(150);
    }
    if (day < 30) firedRef.current = false;
  }, [day]);

  return (
    <section className="tx reveal">
      <div className="wrap">
        <div className="sec-head">
          <div className="divider"></div>
          <h2>See your 30-day transformation</h2>
          <p>Drag the slider and watch your journey come to life — Day 0 to Day 30.</p>
        </div>
        ...
        <div className="tx-card">
          ...
          <div>
            ...
            <a href="#lead" className="btn btn-primary" style={{ width: "100%" }}>
              Start my 30 Days Hard Challenge <span className="arrow">›</span>
            </a>
            <p style={{ fontSize: "11px", color: "var(--sage)", opacity: 0.7, marginTop: "10px", textAlign: "center" }}>
              *Illustrative simulation. Individual results vary; prescribed at a doctor&apos;s discretion.
            </p>
          </div>
        </div>
      </div>
